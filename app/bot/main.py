...
def register_handlers(bot):
    ...
    async def start_handler(event):
        ...
        if not await is_user_fsubbed(bot, user_id):
            return await event.respond(
                ...
                buttons=[[Button.url("Join Channel", "https://t.me/FilmyflixHD")]]
            )

        await event.respond(
            "👋 Welcome to FilmyflixHd Media Streamer!\n\n"
            "Send me any media file and I will generate a direct high-speed download/stream link for you.",
            buttons=[
                [Button.url("Join Channel", "https://t.me/FilmyflixHD"), Button.url("Support", "https://t.me/FilmyflixHD_Supportbot")],
    ...
    async def about_callback(event):
        await event.answer(
            ...
            "Channel: @FilmyflixHD\n"
            "Support: @FilmyflixHD_Supportbot",
            alert=True
        )
